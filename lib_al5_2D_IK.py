...
def al5_2D_IK(targetXYZGWAWR):
    ...
    if ((Elbow <= 0) or (Shoulder <= 0)):
        return 3
    Wrist = fabs(wa - Elbow - Shoulder) - 63
    ...
    motors_SEWBZWrG = (Shoulder, Elbow, Wrist, Z, g)

    # <<< debug <<<
    # print("SHOULDER\tELBOW \tWRIST-A \tBASE-ROT\tGRIPPER\t")
    # print(str(Shoulder) + "\t" + str((180 - Elbow)) + "\t" + str((180 - Wrist)) + "\t" + str(z) + "\t" + str(g) + "\t" + "\t")
    # print(str(getPulseFromAngle(Shoulder)) + "\t" + str(getPulseFromAngle(180 - Elbow)) + "\t" + str(getPulseFromAngle(180 - Wrist)) + "\t" + str(getPulseFromAngle(z)) + "\t" + str(getPulseFromAngle(g)) + "\t" + "\t")
    # >>> debug >>>
